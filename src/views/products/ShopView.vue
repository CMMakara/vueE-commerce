...
const src = ref([
   "https://graphicsfamily.com/wp-content/uploads/edd/2022/06/Free-E-commerce-Product-Banner-Design-with-Green-Colors-1180x664.jpg",
   "https://t4.ftcdn.net/jpg/03/48/05/45/360_F_348054518_7ZBa3gt3i8UrXH7QwvlLxW9ZneBCKHPH.jpg",
   "https://media.gettyimages.com/id/1258130656/vector/businessmans-hand-shopping-online-online-store-on-digital-tablet-with-products.jpg?s=612x612&w=gi&k=20&c=taEMmYfW878crAYWeD41WUa3G0ePfHKptA-VcSuRAF0=",
   "https://t3.ftcdn.net/jpg/04/55/53/78/360_F_455537818_2AwVoujHe2gH7IRYTgrZ932Nt4MdwTXD.jpg",
]);
...
<template>
   <section>
      <div class="container">
         <div
            class="p-3 border shadow-sm"
            style="background-color: #f7f7f7; border-radius: 40px"
         >
   ...
   <section
      class="bg-white shadow-lg rounded-4 p-5 position-relative"
      style="margin-block: 100px; overflow: hidden"
   >
      <div class="container text-center">
         ...
         <!-- Content -->
         <h1
            class="fw-bold text-primary display-4 mb-3 position-relative"
            style="z-index: 1"
         >
            All Products
         </h1>
         ...
         <p
            class="text-secondary fs-5 mb-4 position-relative"
            style="z-index: 1"
         >
            Explore our wide selection of high-quality products, handpicked for
            you.
         </p>
      </div>
   </section>
   ...
   <section class="mt-4">
      ...
      >
         <template #filterBtn>
            <button
               @click="isFilter"
               class="btn btn-dark py-3 pe-5 ps-2 rounded-4 fw-medium shadow-sm"
            >
         ...
         <template #filter>
            <div v-if="filter" class="col-3 category-sidebar">
               <div
                  class="rounded p-3 border bg-light sticky-top"
                  style="top: 20px"
               >
                  ...
                  <div
                     ...
                     v-for="option in categoryStore.categoryName"
                     :key="option.id"
                  >
                     <input
                        class="form-check-input"
      ...
      <div
         class="loader-wrapper w-100 d-flex justify-content-center py-5"
         v-if="loadingPage"
         style="margin-bottom: 30px"
      >
         <div class="loader">
            <span class="l"
               ><svg class="letter" viewBox="0 0 11 18">
                  <path
                     fill="black"
            ...
            ></span>
            <span class="o"
               ><svg class="letter" viewBox="0 0 16 18">
                  <path
                     fill="black"
            ...
            ></span>
            <span class="a"
               ><svg class="letter" viewBox="0 0 15 18">
                  <path
                     fill="black"
            ...
            ></span>
            <span class="d"
               ><svg class="letter" viewBox="0 0 14 18">
                  <path
                     fill="black"
            ...
            ></span>
            <span class="ispan"
               ><svg class="letter i" viewBox="0 0 6 17">
                  <path
                     fill="black"
            ...
            ></span>
            <span class="n"
               ><svg class="letter" viewBox="0 0 13 18">
                  <path
                     fill="black"
